...
import com.hc.smsm_backer.filter.JWTFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean factory(SecurityManager securityManager) {
        ...
        Map<String, Filter> filterMapJwt = new LinkedHashMap<>();
        //设置我们自定义的JWT过滤器
        filterMapJwt.put("jwt", new JWTFilter());
        shiroFilter.setFilters(filterMapJwt);
        Map<String, String> filterMap = new LinkedHashMap<>();
        // 所有请求通过我们自己的JWT Filter
        filterMap.put("/backer/api/**", "jwt");
        filterMap.put("/static/**", "anon");
        filterMap.put("/javascript/**", "anon");
        filterMap.put("/lib/**", "anon");
        filterMap.put("/img/**", "anon");
        filterMap.put("/favicon.ico", "anon");
        filterMap.put("/login", "anon");
        filterMap.put("/login.html", "anon");
        filterMap.put("/backer/manager/login", "anon");
     ...
     */
    @Bean
    public SecurityManager securityManager(CustomRealm customRealm, JwtRealm jwtRealm) {
