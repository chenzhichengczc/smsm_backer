...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		// pull out the basic lines before padding
		if (elem.isArea) {
		...
		if (startBaseLine) { // append the basic lines for areas
...
/**
 * The Point object and prototype. Inheritable and used as basic for PiePoint
 */
var Point = function () {};
Point.prototype = {
...
/**
 * @classDescription The basic function which all other series types inherit from. The data in the series is stored
 * in various arrays.
 *
...
var AreaSeries = extendClass(Series, {
	...
	/**
	 * Extend the basic Series getSegmentPath method by adding the path for the area.
	 * This path is pushed to the series.areaPath property.
	 */
	getSegmentPath: function (segment) {
		
		var segmentPath = Series.prototype.getSegmentPath.call(this, segment), // call basic method
...
var PieSeries = {
	...
	drawDataLabels: function () {
		...
		each(data, function (point) {
			if (point.dataLabel) { // it may have been cancelled in the basic method (#407)
